...
const targets={
 ...
 'src/renderer/app/state/useOrganizationCommandActions.ts':['useOrganizationRegistryActions','useOrganizationTeamActions','useOrganizationWorkLinkActions','return {'],
 'src/renderer/app/state/useOrganizationRegistryActions.ts':['updateDemoOrganization','useCallback','window.orbita','setWorkspaceWriteState','setWorkspace','return {'],
