...
if(!css.includes(marker))css+=`\n\n${marker}\n.documents-workspace-screen .documents-import-consequence{display:grid;gap:2px;align-self:stretch;min-width:190px;padding:7px 10px;border-left:2px solid rgba(52,123,214,.44);background:rgba(244,248,253,.72);color:#586d85}.documents-workspace-screen .documents-import-consequence span{font-size:8px;font-weight:850;letter-spacing:.06em;text-transform:uppercase;color:#70839a}.documents-workspace-screen .documents-import-consequence strong{font-size:9.5px;line-height:1.35;color:#244766}.documents-workspace-screen .documents-import-consequence small{font-size:8px;line-height:1.4;color:#7b8c9e}.documents-workspace-screen .documents-import-workflow{grid-template-columns:minmax(185px,.62fr) minmax(0,1.95fr) minmax(200px,.78fr) auto}.documents-workspace-screen .documents-import-actions{align-self:center}@media(max-width:1500px){.documents-workspace-screen .documents-import-workflow{grid-template-columns:220px minmax(0,1fr)!important;grid-auto-rows:auto;column-gap:14px;row-gap:8px;align-items:start}.documents-workspace-screen .documents-import-fields{grid-column:2;grid-row:1;min-width:0}.documents-workspace-screen .documents-import-consequence{grid-column:2;grid-row:2;min-width:0;align-self:start}.documents-workspace-screen .documents-import-actions{grid-column:1;grid-row:2;align-self:start}.documents-workspace-screen .documents-import-intro{grid-column:1;grid-row:1;min-width:0}}\n`;
fs.writeFileSync(cssOwner,css,'utf8');
console.log(JSON.stringify({state:'W7B_CONSEQUENCE_UX_APPLIED_NOT_ADMITTED',owners:[screen,path.relative(root,cssOwner).replace(/\\/g,'/')],truthTouched:false,responsiveRepair:'1366 and 1440 use the same two-column/two-row import composition; consequence sits below fields and cannot overlap Važi do',semantics:['current Rad-required presentation kept visible','relationship role kept visible','native import command unchanged','managed-copy/SHA outcome described only after successful native import']},null,2));
